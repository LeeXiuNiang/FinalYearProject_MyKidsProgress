...
class NewStudentForm extends StatefulWidget {
  ...
  const NewStudentForm({Key key, this.user}) : super(key: key);
...
class _NewStudentFormState extends State<NewStudentForm> {
              ...
              child: SingleChildScrollView(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(labelText: 'Parent\'s Phone'),
                  ),
                  SizedBox(height: 15),
                  MaterialButton(
  ...
  Future<void> _postNewStudent() async {
    ...
    String studentID = _studentIdController.text.toString();
    ...
    http.post(
        Uri.parse(
            "https://crimsonwebs.com/s272033/mykidsprogress/php/newstudent.php"),
        body: {
          "name": name,
          "studentID": studentID,
          "gender": gender,
